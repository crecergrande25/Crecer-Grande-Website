...
select
  ...
  '7003301781', '6291001781', null, '916291001781',
...
set company_name='Crecer Grande',
    ...
    phone_primary='7003301781', phone_secondary='6291001781', phone_tertiary=null,
...
('contact','Contact','Talk to Crecer Grande.','Use this page for general enquiries, contact details and direct communication. For commercial or technical job review, use the dedicated Request a Quote page.','{}'::jsonb,'Contact Crecer Grande | Enquiries & Contact Details','Contact Crecer Grande for general enquiries, company contact details, engineering support and industrial-services communication.','https://crecergrande.in/contact.html',true),
...
('estimate','Estimate Tools','Industrial engineering calculators for quick planning.','Use theoretical material-weight, nesting, bend, 3D-print, engineering unit-conversion and live currency-reference tools before sending an RFQ. Final drawings, process review and quotation prevail.','{}'::jsonb,'Industrial Engineering Calculators | Crecer Grande','Free industrial engineering calculators from Crecer Grande for material weight, nesting, bend allowance, 3D-print material, engineering unit conversion and live currency reference conversion.','https://crecergrande.in/estimate.html',true),
...
('request-quote','Request a Quote','Share your requirement and we will route it correctly.','Send a drawing, sample, photograph, machine issue, BOM, dimensions or simply the outcome you need. Crecer Grande will review the information and respond through the appropriate technical or commercial route.','{}'::jsonb,'Request a Quote | Crecer Grande','Request a quote from Crecer Grande for manufacturing, engineering design, machine maintenance, automation, industrial spares, inspection, ISO, laser services and tender support.','https://crecergrande.in/request-quote.html',true),
...
-- V2.9 RFQ / CAD attachment contract
-- Keep the master reference aligned with the safe production patch below.
