...
document.addEventListener('DOMContentLoaded',async()=>{
 ...
 const imageFor=x=>{
   const map={
     'single-layer-nozzles':'/assets/images/laser-consumables/single-layer-nozzle.svg',
     'double-layer-nozzles':'/assets/images/laser-consumables/double-layer-nozzle.svg',
     'high-speed-nozzles':'/assets/images/laser-consumables/high-speed-nozzle.svg',
     'protective-window-279-41':'/assets/images/laser-consumables/protective-window-279.svg',
     'protective-window-249-15':'/assets/images/laser-consumables/protective-window-249.svg',
     'protective-windows-other':'/assets/images/laser-consumables/protective-window-multi.svg',
     'focus-lens-group':'/assets/images/laser-consumables/focus-lens-group.svg',
     'collimation-lens-group':'/assets/images/laser-consumables/collimation-lens-group.svg',
     'ceramic-ring':'/assets/images/laser-consumables/ceramic-ring.svg',
     'sensor-body':'/assets/images/laser-consumables/sensor-body.svg',
     'height-sensor-cable':'/assets/images/laser-consumables/height-sensor-cable.svg',
     'lens-drawer':'/assets/images/laser-consumables/lens-drawer.svg',
     'head-seal-kit':'/assets/images/laser-consumables/seal-kit.svg',
     'qbh-qcs-interface':'/assets/images/laser-consumables/qbh-qcs-interface.svg',
     'optics-cleaning':'/assets/images/laser-consumables/optics-cleaning.svg',
