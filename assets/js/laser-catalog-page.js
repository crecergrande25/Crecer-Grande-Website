...
document.addEventListener('DOMContentLoaded',async()=>{
 ...
 const imageFor=x=>{
   const map={
     ...
     'height-sensor-cable':'/assets/images/laser-consumables/generated-sensor-body.webp',
     ...
     'optics-cleaning':'/assets/images/laser-consumables/generated-focus-optics.webp',
