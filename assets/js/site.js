(() => {
  ...
  function injectHeaderStyles(){
    ...
    style.textContent = `.nav .quote-nav{white-space:nowrap}@media(max-width:1160px){.nav{gap:13px!important}.nav>a{font-size:12px!important}}@media(max-width:1050px){.nav .quote-nav{width:100%;text-align:center;justify-content:center}.nav{gap:8px!important}}`;
