...
- Fallback metadata now also includes all 50 published categories, 10 brands and 31 equipment models.
- Automation and 3D Printing root-category mappings now behave consistently in live and offline modes.
- Product Finder now uses each product's canonical catalogue href instead of hardcoding alternate catalogue routes.
...
- Synchronized corrected product images into static Open Graph / Twitter metadata and catalogue-page initial galleries for the products changed by the image audit.
